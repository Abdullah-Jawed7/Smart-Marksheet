...
//   //     `;
//   return(<>
//   {localStorage.setItem('suggestion', JSON.stringify(<Gemini instruction={suggestionPrompt}/>))}
//   {/* <Gemini instruction={suggestionPrompt}/> */}
  
//   <h1 className="text-7xl text-blue-700">Suggestion</h1>
//   {localStorage.getItem('suggestion') && JSON.parse(localStorage.getItem('suggestion') as string)}
//   <h1 className="text-7xl text-blue-700">Career</h1>
//   <Gemini instruction={careerPrompt}/>
//   <h1 className="text-7xl text-blue-700">Summary</h1>
//   <Gemini instruction={summaryPrompt}/>
//   </>)
